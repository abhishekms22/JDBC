...
public class Customers {
	...
	public Connection getConnection()
	{
		try{
			...
			con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl", "abhi", "abhi");
	...
	public void getCustomer() 
	{
	  try {
	   ...
	   rs = st.executeQuery("select * from customer order by cust_id");
